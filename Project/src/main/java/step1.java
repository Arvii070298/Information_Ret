...
public class step1
{
 ...
 public static BooleanQuery toQuery(String queryStr) throws IOException {
    ...
    { 
        ...
        writer1.close();         
	step2.D("1",paragraphsFile,File);
	step2.D("2",paragraphsFile,File);
      step2.D("3",paragraphsFile,File);
      step2.D("4",paragraphsFile,File);
      step2.D("5",paragraphsFile,File); 
	step2.D("6",paragraphsFile,File);
	 step2.D("7",paragraphsFile,File);
	System.out.println("TFIDF Files are being created");
	System.out.print("Spearman Val is :");
	spearman.D();
	
	
       bi_word.D(paragraphsFile,File);
System.out.println("BI WORD file is created");
      IndexElimination.D(File);
	System.out.println("IndexElimination file is created");
      ChampionList.D(paragraphsFile, File);
	System.out.println("championlist file is created");
       L2R.D(File,paragraphsFile,args[2]);
	System.out.println("L2R file is created");
	
	System.out.println("Clusters are: ");
      Clustering.D(paragraphsFile);
    }
}
